...
import { addToCart,updateCartBackend } from "../redux/reducer/cartReducer";
...
const banners = [
  // "https://res.cloudinary.com/dyrb6edej/image/upload/v1728881327/3100075_ixhjbm.jpg",
  "https://res.cloudinary.com/dyrb6edej/image/upload/v1728881092/banner2_kza3u6.png",
  "https://res.cloudinary.com/dyrb6edej/image/upload/v1728881091/banner1_lzca0p.png",
];
const categories = [
  "Electronics",
  "Mobiles",
  ...
  return (
    <>
      ...
      <article className="cover-video-container">
        ...
        <video autoPlay loop muted src='https://res.cloudinary.com/dyrb6edej/video/upload/v1728880667/cover_wqtoud.mp4' />
